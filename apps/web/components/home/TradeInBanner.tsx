  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="bg-black rounded-3xl overflow-hidden relative flex flex-col md:flex-row items-center">
          <div className="p-12 md:w-1/2 text-white z-10">
            ...
            <button className="bg-white text-black px-8 py-3 font-bold rounded-full hover:bg-blue-600 hover:text-white transition">
              Định giá ngay
            </button>
          </div>
