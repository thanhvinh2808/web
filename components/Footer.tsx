      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">
              Cửa hàng công nghệ uy tín với hơn 10 năm kinh nghiệm
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/return-policy" className="hover:text-blue-400 transition">
                  Chính sách đổi trả
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center space-x-2">
                <span className="text-blue-400">📞</span>
                <a href="tel:1900xxxx" className="hover:text-blue-400 transition">
                  1900 xxxx
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <span className="text-blue-400">✉️</span>
                <a href="mailto:support@techstore.vn" className="hover:text-blue-400 transition">
