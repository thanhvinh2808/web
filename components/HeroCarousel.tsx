...
import banner3 from '../app/images/banner3.png';
import banner4 from '../app/images/banner4.png';
import banner5 from '../app/images/banner5.png';
import banner6 from '../app/images/banner6.png';
import banner7 from '../app/images/banner7.png';
import banner8 from '../app/images/banner8.png';
  ...
  const mainBanners = [
    {
      ...
      slug: 'sieu-sale-mua-he', // ✅ Slug danh mục
      link: '/products' // Link động theo slug
    },
    {
      id: 2,
      image: banner2,
            ...
            {sideBanners.map((banner) => (
              ...
              >
                <div className="relative h-32 md:h-44 lg:h-[230px]">
                  {/* ✅ Fixed: Dùng Next.js Image component */}
                  <Image
                    src={banner.image}
                    alt={banner.alt}
                    fill
